...
const remoteBrowserImports = Object.freeze({
  ...
  "@hugeicons/core-free-icons/CursorMagicSelection04Icon": "https://esm.sh/@hugeicons/core-free-icons@4.3.0/CursorMagicSelection04Icon",
  "@hugeicons/core-free-icons/CheckIcon": "https://esm.sh/@hugeicons/core-free-icons@4.3.0/CheckIcon",
  "@hugeicons/core-free-icons/ChevronsLeftRightIcon": "https://esm.sh/@hugeicons/core-free-icons@4.3.0/ChevronsLeftRightIcon",
  "@hugeicons/core-free-icons/Share01Icon": "https://esm.sh/@hugeicons/core-free-icons@4.3.0/Share01Icon",
  "@hugeicons/core-free-icons/HistoryIcon": "https://esm.sh/@hugeicons/core-free-icons@4.3.0/HistoryIcon",
  "@hugeicons/core-free-icons/Copy01Icon": "https://esm.sh/@hugeicons/core-free-icons@4.3.0/Copy01Icon",
...
function platformRemoteBrowserImports() {
  const importPrefixes = Object.entries(remoteBrowserImports).filter(([specifier]) =>
    specifier.endsWith("/"),
  );
  return {
    ...
    enforce: "pre",
    resolveId(id) {
      const directTarget = remoteBrowserImports[id];
      const prefixMatch = importPrefixes.find(([specifier]) => id.startsWith(specifier));
      const target = directTarget
        ?? (prefixMatch
          ? `${prefixMatch[1]}${id.slice(prefixMatch[0].length)}`
          : null);
