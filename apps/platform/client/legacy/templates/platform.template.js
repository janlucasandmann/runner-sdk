  ...
  __PLATFORM_COMPATIBILITY_BINDING_062__
        ...
        import { formatPlatformResourceUpdatedAt } from "/dist/platform-ui/formatting/index.js";
        ...
        import {
          ...
          getPlatformConnectorPermissionSubjectTypes,
  ...
  __PLATFORM_COMPATIBILITY_BINDING_086__
        ...
        function consumePlaygroundPluginConnectionReturnUrlState() {
          try {
            const returnState = readPlatformPluginConnectionReturnUrlState(window.location.href);
            const clearedUrl = new URL(
              clearPlatformPluginConnectionReturnUrlState(window.location.href),
            );
            window.history.replaceState(
              window.history.state,
              "",
              clearedUrl.pathname + clearedUrl.search + clearedUrl.hash,
            );
            return returnState;
          } catch {
            return null;
  ...
  __PLATFORM_COMPATIBILITY_BINDING_090__
        ...
        function canRenderAvatarImage(value) {
          ...
          return normalized.startsWith("data:image/")
            ...
            || normalized.startsWith("/api/platform/account/avatar/")
  ...
  __PLATFORM_COMPATIBILITY_BINDING_095__      function normalizePlaygroundAgentRecord(agent) {
          ...
          return {
            ...
            createdAt: typeof agent.createdAt === "string" && agent.createdAt ? agent.createdAt : fallbackTimestamp,
            updatedAt: typeof agent.updatedAt === "string" && agent.updatedAt ? agent.updatedAt : fallbackTimestamp,
  ...
  __PLATFORM_COMPATIBILITY_BINDING_135__
