...
for (const relativePath of [
  ...
  "src/react/runner-chat/canonical-message-metadata.ts",
  ...
  "src/react/runner-chat/turn-presentation.tsx",
  ...
  "src/react/runner-chat/use-work-log-pagination.ts",
