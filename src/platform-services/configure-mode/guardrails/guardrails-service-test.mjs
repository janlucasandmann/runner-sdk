...
assert.doesNotMatch(GUARDRAILS_APP_SCRIPT_FRAGMENTS.topNavigation, /Copy Guardrail ID/);
...
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /React\.createElement\(PlatformSettingsTableSection/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /className: "platform-settings-table-section__table playground-agent-guardrails-platform-table"/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /className: "platform-settings-table-section__toolbar"/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /function renderAgentGuardrailFilterControl\(\)/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /titleActions: renderAgentGuardrailFilterControl\(\)/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /React\.createElement\(HugeiconsIcon, \{\s*icon: ListFilterIcon,/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /layout: "fill"/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /variant: "minimalistic-ui"/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /selection: \{\s*enabled: true,/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /trailing: React\.createElement\(PlatformPopup/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /React\.createElement\(PlatformPrimaryButton/);
assert.match(GUARDRAILS_AGENT_PAGE_SCRIPT, /React\.createElement\(PlatformEmptyState/);
assert.doesNotMatch(GUARDRAILS_AGENT_PAGE_SCRIPT, /label: "Add first Guardrail"/);
