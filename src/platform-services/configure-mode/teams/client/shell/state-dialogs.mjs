export const TEAMS_STATE_DIALOGS_SCRIPT = `	        const [teamPageCreateName, setTeamPageCreateName] = useState("");
        ...
        const [teamPageIdentityDraftTeamId, setTeamPageIdentityDraftTeamId] = useState("");
        const [teamPageIdentityNameDraft, setTeamPageIdentityNameDraft] = useState("");
        const [teamPageIdentityDescriptionDraft, setTeamPageIdentityDescriptionDraft] = useState("");
