...
This directory contains application-shell state, lifecycle, and navigation integration for the Teams service in Configure Mode. It remains subordinate to the service boundary and must not become a cross-service utility layer.

## Contents

- [`dialog-lifecycle.mjs`](dialog-lifecycle.mjs) — Focused implementation of Dialog Lifecycle.
