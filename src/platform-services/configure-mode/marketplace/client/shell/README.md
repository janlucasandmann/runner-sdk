...
This directory contains application-shell state, lifecycle, and navigation integration for the Marketplace service in Configure Mode. It remains subordinate to the service boundary and must not become a cross-service utility layer.
...
- [`top-nav-icon.mjs`](top-nav-icon.mjs) — Focused implementation of Top Nav Icon.
