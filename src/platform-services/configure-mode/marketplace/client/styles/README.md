...
This directory contains ordered, owner-scoped style modules for the Marketplace service in Configure Mode. It remains subordinate to the service boundary and must not become a cross-service utility layer.
