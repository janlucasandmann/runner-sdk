export const EVALUATIONS_PAGE_PERSISTENCE_SCRIPT = String.raw`      function readPlaygroundEvaluationSetsFromStorage() {
      ...
      function buildPlaygroundEvaluationRunBackendPayload(run) {
        ...
        return {
          ...
          passRate: normalizedRun.scoredCount > 0 ? normalizedRun.passedCount / normalizedRun.scoredCount : null,
          pass_rate: normalizedRun.scoredCount > 0 ? normalizedRun.passedCount / normalizedRun.scoredCount : null,
          scoredCount: normalizedRun.scoredCount,
          scored_count: normalizedRun.scoredCount,
          failedCount: normalizedRun.failedCount,
          failed_count: normalizedRun.failedCount,
          invalidCount: normalizedRun.invalidCount,
          invalid_count: normalizedRun.invalidCount,
          graderErrorCount: normalizedRun.graderErrorCount,
          grader_error_count: normalizedRun.graderErrorCount,
          infrastructureErrorCount: normalizedRun.infrastructureErrorCount,
          infrastructure_error_count: normalizedRun.infrastructureErrorCount,
          unscoredCount: normalizedRun.unscoredCount,
          unscored_count: normalizedRun.unscoredCount,
          datasetFingerprint: normalizedRun.datasetFingerprint,
          dataset_fingerprint: normalizedRun.datasetFingerprint,
          caseSelectionFingerprint: normalizedRun.caseSelectionFingerprint,
          case_selection_fingerprint: normalizedRun.caseSelectionFingerprint,
          evaluatorFingerprint: normalizedRun.evaluatorFingerprint,
          evaluator_fingerprint: normalizedRun.evaluatorFingerprint,
          systemFingerprint: normalizedRun.systemFingerprint,
          system_fingerprint: normalizedRun.systemFingerprint,
          runFingerprint: normalizedRun.runFingerprint,
          run_fingerprint: normalizedRun.runFingerprint,
