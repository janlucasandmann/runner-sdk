...
This directory contains application-shell state, lifecycle, and navigation integration for the Develop Home service in Develop Mode. It remains subordinate to the service boundary and must not become a cross-service utility layer.
...
- [`metrics-state.mjs`](metrics-state.mjs) — State and projection logic for Metrics State.
