...
This directory contains application-shell state, lifecycle, and navigation integration for the App Header shell feature. Product-domain behavior remains with its owning service or resource.
