...
This directory contains application-shell state, lifecycle, and navigation integration for the Navigation Guard shell feature. Product-domain behavior remains with its owning service or resource.
