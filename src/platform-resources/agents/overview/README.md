...
- [`agents-overview-page.test.tsx`](agents-overview-page.test.tsx) — Regression coverage for the Agents and Squads overview modes.
- [`agents-overview-page.tsx`](agents-overview-page.tsx) — Presentation composition for the analytics-catalog Agents Overview Page.
