...
export interface RunnerMetronomeVersionCreateInput extends RunnerResourceVersionCreateInput<RunnerMetronomeVersionSnapshot> {
  /** @deprecated Metronome version labels are generated by the API as vN. */
  label?: string;
  /** @deprecated Metronome version names are generated by the API as vN. */
  name?: string;
  metronome?: Record<string, unknown>;
  workflow?: Record<string, unknown>;
}
export interface RunnerMetronomeVersionUpdateInput extends RunnerResourceVersionUpdateInput<RunnerMetronomeVersionSnapshot> {
  /** @deprecated Metronome version labels are immutable and generated by the API. */
  label?: string;
  /** @deprecated Metronome version names are immutable and generated by the API. */
  name?: string;
}
