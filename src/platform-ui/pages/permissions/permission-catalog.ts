...
export const PLATFORM_PERMISSION_ACTION_DEFINITIONS: readonly PlatformPermissionActionDefinition[] = [
  ...
  },
  {
    ...
    ringId: "ring_1",
    label: "View library",
    description: "View this Knowledge library, its published documents, metadata, and version history.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_search",
    ringId: "ring_1",
    label: "Search library",
    description: "Retrieve passages from published library versions for humans and authorized agents.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_read",
    ...
    description: "Open the documents and immutable version snapshots in this Knowledge library.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_edit",
    ringId: "ring_2",
    label: "Edit library",
    description: "Change the library identity and edit draft document content.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_documents_manage",
    ringId: "ring_2",
    label: "Manage documents",
    description: "Create, reorganize, archive, and restore documents in this library.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_versions_manage",
    ringId: "ring_2",
    label: "Manage versions",
    description: "Create, compare, and restore immutable Knowledge library versions.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_propose",
    ringId: "ring_2",
    label: "Propose knowledge",
    description: "Let agents and people contribute observations to a draft without permission to publish it.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    ...
    description: "Publish the exact library version used by agents and API retrieval.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_access_manage",
    ringId: "ring_3",
    label: "Manage access",
    description: "Share this Knowledge library with teams and change their role permissions.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
    id: "knowledge_delete",
    ...
    description: "Permanently delete this library, all documents, and its complete version history.",
    subjectTypes: ["knowledge_library", "knowledge_library_team_role"],
  },
  {
