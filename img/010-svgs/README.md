...
This directory contains legacy svg assets consumed by platform presentation. Keep source attribution and usage discoverable, and avoid duplicating equivalent assets.

## Contents

- [`animated_cube_layer.svg`](animated_cube_layer.svg) — Presentation asset.
