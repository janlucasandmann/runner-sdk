...
This directory contains file-type icons consumed by platform presentation. Keep source attribution and usage discoverable, and avoid duplicating equivalent assets.

## Contents

- [`email-attachment.png`](email-attachment.png) — Presentation asset.
